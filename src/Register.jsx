  ...
  return (
    ...
    <div className='bg-slate-100 flex flex-col items-center justify-center text-center min-h-[60%] min-w-[35%] rounded-2xl border border-slate-300 lg:min-w-[20%]'>
        <div className="space-y-1 my-3">
            <h1 className=' mt-5 text-2xl font-extrabold m-3'>Register account</h1>
      ...
      <div className="max-w-md w-full mx-auto rounded-lg p-7 space-y-3">
        ...
        <div className="flex flex-col">
            ...
            <input className='border border-rounded-md px-2 py-2 cursor-pointer text-center' type="password" name='password' id='password' placeholder='Password'/>
        </div>
        <div className="flex flex-col">
            <label className='mb-1 tex-sm ' htmlFor="email">Confirm password</label>
            <input className='border border-rounded-md px-2 py-2 cursor-pointer text-center' type="password" name='password' id='password' placeholder='Confirm password'/>
        </div>
        <div>
            <Link to='/'><button className='w-full rounded bg-slate-500 text-white py-2 hover:bg-blue-600'>Register</button></Link>
        </div>
        <div>
