...
const Login = () => {
  return (
    <div className='bg-slate-100 flex flex-col items-center justify-center text-center min-h-[60%] min-w-[35%] rounded-2xl ml-40 border border-slate-300 lg:min-w-[20%]'>
        <div className="space-y-3 my-5">
            <h1 className='mb-6 text-3xl font-extrabold m-3'>Sign in</h1>
            <p>
                or 
                <a className='text-indigo-600 pl-1 hover:underline' href="/">Register</a>
            </p>
        </div>
